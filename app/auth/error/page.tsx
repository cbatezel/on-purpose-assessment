        ...
        {sent ? (
          <div style={{textAlign:"center"}}>
            ...
            <p style={{fontSize:15,lineHeight:1.65,color:C.inkMid,marginBottom:28}}>
              We sent a new sign-in link to <strong>{email}</strong>. Click the link in your email to continue.
            </p>
          ...
          <>
            ...
            <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:26,
              ...
              Your link has expired<span style={{color:C.red}}>.</span>
            </h1>
            <p style={{fontSize:15,lineHeight:1.65,color:C.inkMid,marginBottom:28,textAlign:"center"}}>
              Magic links expire after a short time for security. Enter your email below and we&apos;ll send a fresh one.
            </p>
